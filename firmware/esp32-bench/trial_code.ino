...
const int HX711_dout_1 = 25; //mcu > HX711 no 1 dout pin
const int HX711_sck_1 = 26; //mcu > HX711 no 1 sck pin

const int HX711_dout_2 = 32; //mcu > HX711 no 2 dout pin
const int HX711_sck_2 = 33; //mcu > HX711 no 2 sck pin

const int HX711_dout_3 = 17; //mcu > HX711 no 2 dout pin
const int HX711_sck_3= 16; //mcu > HX711 no 2 sck pin
